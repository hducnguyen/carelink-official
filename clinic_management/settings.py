...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # Middleware cho đa ngôn ngữ
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.i18n',  # Thêm context processor cho i18n
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'app_staff:dashboard'
LOGOUT_REDIRECT_URL = 'app_home:home'